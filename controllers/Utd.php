 ...
 */
	...
	/* 	if(!empty($_FILES["sk_pembentukan"]["name"])){
		...
		$datas = array(
				...
				'surat_izin_operasional_utd' =>$post['surat_izin_operasional_utd'],
				/* 'sk_pembentukan' =>$surat_sk_pembentukan, */
				'surat_permohonan_registrasi' =>$post['surat_permohonan_registrasi'],
				...
				'upload_sertifikat_akreditasi'=>$post['upload_sertifikat_akreditasi'],
				'tanggal_berakhir_akreditasi' => date('Y-m-d',strtotime($post['tanggal_berakhir_akreditasi'])),
				'cpob' => $post['cpob'],
				'upload_sertifikat_cpob'=>$post['upload_sertifikat_cpob'],
