...
<section class="content">
      <div class="row">
        <div class="col-xs-12">
			  <h3 class="page-header">TAMBAH MASTER DATA SARPRAS</h3>
              ...
              <div class="box-body">
				...
				<div class="form-group">
				 <label  class="col-sm-2 control-label">TYPE</label>
				  <div class="col-sm-5">
				 <?=form_dropdown('type', dropdown_type_sarpras(), $data[0]['type'],'id="type" required class="form-control select2"');?>
				  </div>
				  <div style="clear:both;"></div>
                </div>
				
				<div class="form-group">
				 <label  class="col-sm-2 control-label">TYPE BANGUNAN</label>
				  <div class="col-sm-5">
				 <?=form_dropdown('type_bangunan', dropdown_type_bangunan_sarpras(), $data[0]['type_bangunan'],'id="type_bangunan"  class="form-control select2"');?>
				  </div>
				  <div style="clear:both;"></div>
                </div>
				...
				<div class="form-group">
				 ...
				 <?=form_dropdown('auth', dropdown_auth(), $data[0]['auth'],'id="auth"  class="form-control select2"');?>
				  </div>
				  <div style="clear:both;"></div>
                </div>
				...
				<div class="form-group">
				 ...
				 <div class="form-group">
				  <label  class="col-sm-2 control-label">SARPRAS *</label>
				   <div class="col-sm-5">
                  <input type="text" name="sarpras_alkes" value="<?=$data[0]['sarpras_alkes']?>" required class="form-control" autocomplete="off" >
				  </div>
				  <div style="clear:both;"></div>
                </div>
