      ...
      <div class="box box-info">
            ...
            <form  method="POST" action="">
              <div class="box-body">
				...
				<div class="form-group">
				  <label  class="col-sm-2 control-label">KETERANGAN</label>
				   <div class="col-sm-5">
                  <textarea name="sub_keterangan" style="width:100%"><?=$data[0]['sub_keterangan']?></textarea>
				  </div>
				  <div style="clear:both;"></div>
                </div>
             ...
             <div class="form-group">
                  ...
                  <input type="number" name="urut" value="<?=$data[0]['urut']?>" required class="form-control" autocomplete="off" >
				  </div>
				  <div style="clear:both;"></div>
                </div>
