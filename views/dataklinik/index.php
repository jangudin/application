											...
											<div class="box-body">
												...
												<div class="form-group">
													...
													<div class="col-sm-5">
														...
														<input type="hidden" name="nama_klinik_old" value="<?= (!empty($data[0]['nama_klinik']) ? $user[0]['nama_fasyankes'] : $user[0]['nama_fasyankes']) ?>" id="nama_klinik_old">
		...
		if ("geolocation" in navigator){
			navigator.geolocation.getCurrentPosition(function(position){ 
				...
				document.getElementById("tampil").innerHTML = infoWindowHTML; 
												...
												?>
												<!-- <div class="form-group">
													<label class="col-sm-2 control-label">Link Drive Dokumen Perizinan Klinik</label>
													<div class="col-sm-5">
														<input type="file" name="operasional" id="operasional" <?= $auth_wajib_surat_izin ?>> -->
														<!-- <a target="_blank" href="<?php // echo $data[0]['url_dokumen_operasional']; ?>"><?php // echo $data[0]['operasional']; ?></a> -->
														<!-- <a target="_blank" href="<?php // echo (!empty($data[0]['url_dokumen_operasional']) ? $data[0]['url_dokumen_operasional'] : $upload_path . 'assets/uploads/berkas_sip/' . $data[0]['operasional']); ?>"><?php echo $data[0]['operasional']; ?></a>
												...
												<!-- <div class="form-group">
													<label class="col-sm-2 control-label">Link Drive SURAT PERMOHONAN REGISTRASI FASYANKES</label>
													<div class="col-sm-5">
														<input type="file" name="dokumen_registrasi" <?= $disabled_html ?> id="dokumen_registrasi">
														<a target="_blank" href="<?php // echo $data[0]['url_dokumen_registrasi']; ?>"><?php // echo $data[0]['dokumen_registrasi']; ?></a>
												...
												<!-- <div class="form-group">
													<label class="col-sm-2 control-label">Link Drive Dokumen Akreditasi Fasyankes</label>
													<div class="col-sm-5">
														<input type="file" name="bukti_penanaman_modal_asing" id="bukti_penanaman_modal_asing">
														<a target="_blank" href="<?php // echo $data[0]['url_dokumen_penanaman_modal_asing']; ?>"><?php echo $data[0]['bukti_penanaman_modal_asing']; ?></a>
												...
												<div class="form-group">
													<label class="col-sm-2 control-label">Link Drive Dokumen Perizinan Klinik</label>
													<div class="col-sm-5">
														<input type="text" name="operasional" value="<?= $data[0]['url_dokumen_operasional'] ?>" class="form-control" autocomplete="off" id="operasional" required>
														<input type="hidden" name="old_operasional" value="<?= $data[0]['operasional'] ?>" id="old_operasional">
													</div>
													<div style="clear:both;"></div>
												</div>
												...
												<div class="form-group">
													<label class="col-sm-2 control-label">Link Drive SURAT PERMOHONAN REGISTRASI FASYANKES</label>
													<div class="col-sm-5">
														<input type="text" name="dokumen_registrasi" value="<?= $data[0]['url_dokumen_registrasi'] ?>" class="form-control" autocomplete="off" id="dokumen_registrasi" required>
														<input type="hidden" name="old_dokumen_registrasi" value="<?= $data[0]['dokumen_registrasi'] ?>" id="old_dokumen_registrasi">
													</div>
													<div style="clear:both;"></div>
												</div>
												...
												<div class="form-group">
													<label class="col-sm-2 control-label">Link Drive Dokumen Akreditasi Fasyankes</label>
													<div class="col-sm-5">
														<input type="text" name="bukti_penanaman_modal_asing" value="<?= $data[0]['url_dokumen_penanaman_modal_asing'] ?>" class="form-control" autocomplete="off" id="dokumen_registrasi" required>
														<input type="hidden" name="old_bukti_penanaman_modal_asing" value="<?= $data[0]['old_bukti_penanaman_modal_asing'] ?>" id="old_bukti_penanaman_modal_asing">
													</div>
													<div style="clear:both;"></div>
												</div>
