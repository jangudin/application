	...
	<div class="box">
		<div class="box-content">
			<ul id="myTab" class="nav nav-tabs">
				<li><a href="<?php echo base_url('rs/list_user_yang_mengajukan_kota'); ?>">RS(Sudah Validasi)</a></li>
				<li class="active"><a href="<?php echo base_url('rs/list_user_yang_mengajukan_kota_belum_validasi'); ?>">RS(Belum Validasi)</a></li>
