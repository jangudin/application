    	...
    	<div class="box">
    		<div class="box-content">
			  <ul id="myTab" class="nav nav-tabs">
                  <li class="active"><a href="<?php echo base_url('rs/list_user_yang_mengajukan_kemkes');?>">RS(Sudah Validasi)</a></li> 
				  <li ><a href="<?php echo base_url('rs/list_user_yang_mengajukan_kemkes_belum_validasi');?>">RS(Belum Validasi)</a></li> 
				    <li ><a href="<?php echo base_url('rs/list_user_yang_mengajukan_kemkes_perbaikan');?>">RS(Perbaikan)</a></li> 
              </ul>
			    <div id="myTabContent" class="tab-content">
			 <div class="tab-pane fade in active">
			 <br>
    			<h3 class="page-header">LIST RS YANG MENGAJUKAN KODE(Sudah Validasi)</h3>
<!--
...
<table class="table-bordered table-condensed"  width="100%" >
		...
		?>
			<tr>
			<td><?php echo $id; ?></td>
			<td><?php echo $value['nama_rs']; ?></td>
			<td><?php echo $value['alamat_daskes']; ?></td>
