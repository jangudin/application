    		...
    		<div class="box-content">
			  <ul id="myTab" class="nav nav-tabs">
				  ...
				  <li ><a href="<?php echo base_url('rs/list_user_yang_mengajukan_kemkes_belum_validasi');?>">RS(Belum Validasi)</a></li> 
				    <li class="active"><a href="<?php echo base_url('rs/list_user_yang_mengajukan_kemkes_perbaikan');?>">RS(Perbaikan)</a></li> 
              </ul>
			    <div id="myTabContent" class="tab-content">
			 <div class="tab-pane fade in active">
			 <br>
    			<h3 class="page-header">LIST RS YANG MENGAJUKAN KODE(Perbaikan)</h3>
<!--
