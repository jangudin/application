                                ...
                                <div class="col-md-12" >
                                    ...
                                    <div class="box box-primary">
                                                ...
                                                <form role="form" method="POST" action="" enctype='multipart/form-data'>
                                                    <div class="box-body">
                                                    <a href="index_penurunan_skor_ohis_pasien" class="btn btn-lg text-center"><span><i class="fa fa-arrow-left fa-1x"></i></span> Kembali</a>
                                                    <h3>  Tambah Data Penurunan Skor OHIS Pasien</h3>
                                                        </br>
                                                    ...
                                                    <div class="box-body">
                                                        <div class="form-group">
                                                            <label  class="col-sm-2 control-label">Pasien Gigi Dengan Penurunan Skor OHIS</label>
                                                                <div class="col-sm-5">
                                                                    <input type="number" name="pasien_gigi_dengan_penurunan_skor_ohis"  id="pasien_gigi_dengan_penurunan_skor_ohis" min="0"  class="form-control" autocomplete="off">
                                                                </div>  
                                                            <div style="clear:both;"></div>
                                                        </div>
                                                    </div>
                                                    <div class="box-body">
                                                        <div class="form-group">
                                                            <label  class="col-sm-2 control-label">Jumlah Pasien Gigi</label>
                                                                <div class="col-sm-5">
                                                                    <input type="number" name="jumlah_pasien_gigi"  id="jumlah_pasien_gigi" min="0"  class="form-control" autocomplete="off">
                                                                </div>  
                                                            <div style="clear:both;"></div>
                                                        </div>
                                                    </div>
