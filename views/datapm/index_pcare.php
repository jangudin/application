                                                ...
                                                <form role="form" method="POST" action="" enctype='multipart/form-data'>
                                                    ...
                                                    <div class="box-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label  class="col-sm-2 control-label">Link Upload File</label>
                                                                <div class="col-sm-5">
														...
														<input type="text" name="dokumen_integrasi_pcare" value="<?= (empty($pcare[0]['dokumen_integrasi_pcare']) ? $pcare[0]['dokumen_integrasi_pcare'] : $pcare[0]['dokumen_integrasi_pcare']) ?>" class="form-control"  autocomplete="off">
