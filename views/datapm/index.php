											...
											<div class="box-body">
												...
												<div class="form-group">
													...
													<div class="col-sm-5">
														...
														<input type="hidden" name="kode" value="<?= (!empty($data[0]['kode_faskes_baru']) ? $data[0]['kode_faskes_baru'] : '') ?>" id="kode">
													...
													</div>/* Nama sesuai dengan KTP dilengkapi gelar dokter atau dokter gigi dan gelar spesialis jika ada (contoh : dr. Budi)
												...
												<div class="form-group">
													<label class="col-sm-2 control-label">Link UPLOAD SURAT IZIN PRAKTIK (SIP)</label>
													<div class="col-sm-5">
														<!-- <input type="file" name="dokumen_sip" id="dokumen_sip" >
														...
														<input type="text" name="dokumen_sip" value="<?= (empty($data[0]['dokumen_sip']) ? $data[0]['dokumen_sip'] : $data[0]['dokumen_sip']) ?>" class="form-control"  autocomplete="off">
													</div>
													<div style="clear:both;"></div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-5">
														<?= form_dropdown('sip_ke_berapa', dropdown_sip_ke_brp(), (!empty($data[0]['sip_ke_berapa']) ? $data[0]['sip_ke_berapa'] : '1'), 'id="sip_ke_berapa"  required class="form-control select2"'); ?>
													</div>
													<div style="clear:both;"></div>
												</div>
												...
												<div class="form-group">
													<label class="col-sm-2 control-label">Link UPLOAD SURAT TANDA REGISTRASI (STR)</label>
													<div class="col-sm-5">
														...
														<input type="text" name="dokumen_str" value="<?= (empty($data[0]['dokumen_str']) ? $data[0]['dokumen_str'] : $data[0]['dokumen_str']) ?>" class="form-control" required autocomplete="off">
		...
		if ("geolocation" in navigator){
			navigator.geolocation.getCurrentPosition(function(position){ 
				...
				document.getElementById("tampil").innerHTML = infoWindowHTML; 
												...
												<div class="form-group">
													<label class="col-sm-2 control-label">EMAIL FASKES</label>
													<div class="col-sm-5">
												...
												<div class="form-group">
													<label class="col-sm-2 control-label">LINK UPLOAD SURAT PERMOHONAN REGISTRASI FASYANKES</label>
													<div class="col-sm-5">
														...
														<input type="text" name="dokumen_registrasi" value="<?= (empty($data[0]['dokumen_registrasi']) ? $data[0]['dokumen_registrasi'] : $data[0]['dokumen_registrasi']) ?>" class="form-control" required autocomplete="off">
												...
												<div class="form-group">
													<label class="col-sm-2 control-label">Link Upload dokumen kewenangan tambahan</label>
													<div class="col-sm-5">
														...
														<input type="text" name="dokumen_kewenangan" value="<?= (empty($data[0]['dokumen_kewenangan']) ? $data[0]['dokumen_kewenangan'] : $data[0]['dokumen_kewenangan']) ?>" class="form-control"  autocomplete="off">
						...
						-->
												...
												<div class="form-group">
													<label class="col-sm-2 control-label">Link Upload Pernyataan Komitmen Mutu</label>
													<div class="col-sm-5">
														...
														<input type="text" name="dokumen_komitmen" value="<?= (empty($data[0]['dokumen_komitmen']) ? $data[0]['dokumen_komitmen'] : $data[0]['dokumen_komitmen']) ?>" class="form-control"  autocomplete="off">
