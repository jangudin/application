                                            ...
                                            <form role="form" method="POST" action="" enctype='multipart/form-data'>
                                                <table class="table table-bordered">
                                                    <tbody>
                                                        ...
                                                        <?php
                                                            $no=0;
                                                            foreach(dropdown_sarpras_alkes_pm2($user[0]['id_kategori']) as $key => $value){
                                                            $no++;

                                                        ?>
                                                        <tr>
                                                            <td><?=$no;?></td>
                                                            <td><?php foreach(dropdown_sarpras_alkes_pm_type2($key) as $key2 => $value2){ echo $value2;  }?></td>
                                                        <!--	  <td><?php //foreach(dropdown_sarpras_alkes_pm_type_bangunan($key) as $key2 => $value2){ echo $value2;  }?></td>-->
                                                            ...
                                                            <td>
                                                                ...
                                                                <input type="radio" id="chkYes<?=$key;?>" name="is_checked[<?=$key;?>]" value="1"> <label for="chkYes<?=$key;?>"><?php foreach(dropdown_sarpras_alkes_pm_label_nilai_satu($key) as $key3 => $label_nilai_satu){ echo $label_nilai_satu;  }?></label>
                                                                <input type="radio" id="chkNo<?=$key;?>" name="is_checked[<?=$key;?>]" value="2"> <label for="chkNo<?=$key;?>"><?php foreach(dropdown_sarpras_alkes_pm_label_nilai_dua($key) as $key4 => $label_nilai_dua){ echo $label_nilai_dua;  }?></label>
                                                            </td>
                                                            <td>
                                                                <?php 
                                                                    if($key == 1 || $key == 13){
