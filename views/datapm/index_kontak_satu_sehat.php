            ...
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="<?php echo base_url('pm/inputan_data_alkes_obat_pm');?>" >Alkes</a></li>
                        ...
                        <li class="active"><a href="<?php echo base_url('pm/kontak_satu_sehat');?>">Kontak SATUSEHAT</a></li>
                                                ...
                                                <form role="form" method="POST" action="" enctype='multipart/form-data'>
                                                    ...
                                                    <div class="box-body">
                                                        <div class="form-group">
                                                            <label  class="col-sm-2 control-label">Nama PIC Integrasi SatuSehat</label>
                                                                <div class="col-sm-5">
                                                                    <input type="text" name="nama_pic" value="<?=(!empty($data3[0]['nama_pic']) ? $data3[0]['nama_pic'] : '')?>" required id="nama_pic"  class="form-control" autocomplete="off">
                                                                </div>  
                                                    ...
                                                    <div class="box-body">
                                                        <div class="form-group">
                                                            <label  class="col-sm-2 control-label">Nomor Telfon/WA PIC</label>
                                                                <div class="col-sm-5">
                                                                <input type="text" name="telp_pic"  value="<?=(!empty($data3[0]['telp_pic']) ? $data3[0]['telp_pic'] : '')?>"  class="form-control" required autocomplete="off"  >
                                                                </div>  
                                                            <div style="clear:both;"></div>
                                                        </div>
                                                    </div>
                                                    <div class="box-body">
                                                        <div class="form-group">
                                                            <label  class="col-sm-2 control-label">Email yang digunakan untuk integrasi seluruh ekosistem SatuSehat</label>
                                                                <div class="col-sm-5">
                                                                    <input type="text" name="email_integrasi" value="<?=(!empty($data3[0]['email_integrasi']) ? $data3[0]['email_integrasi'] : '')?>" required id="email_integrasi"  class="form-control" autocomplete="off">
                                                                </div>  
                                                            <div style="clear:both;"></div>
                                                        </div>
                                                    </div>
