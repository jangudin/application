                                ...
                                <div class="col-md-12" >
                                    ...
                                    <div class="box box-primary">
                                                ...
                                                <form role="form" method="POST" action="" enctype='multipart/form-data'>
                                                    <div class="box-body">
                                                    <a href="index_kepatuhan_kunjungan_pasien_hipertensi" class="btn btn-lg text-center"><span><i class="fa fa-arrow-left fa-1x"></i></span> Kembali</a>
                                                    <h3>  Tambah Data Kepatuhan Kunjungan Pasien Hipertensi</h3>
                                                        </br>
                                                    ...
                                                    <div class="box-body">
                                                        <div class="form-group">
                                                            <label  class="col-sm-2 control-label">Pasien Patuh</label>
                                                                <div class="col-sm-5">
                                                                    <input type="number" name="pasien_patuh"  id="pasien_patuh" min="0"  class="form-control" autocomplete="off">
                                                                </div>  
                                                            <div style="clear:both;"></div>
                                                        </div>
                                                    </div>
                                                    <div class="box-body">
                                                        <div class="form-group">
                                                            <label  class="col-sm-2 control-label">Jumlah Pasien Hipertensi</label>
                                                                <div class="col-sm-5">
                                                                    <input type="number" name="jumlah_pasien_hipertensi"  id="jumlah_pasien_hipertensi" min="0"  class="form-control" autocomplete="off">
                                                                </div>  
                                                            <div style="clear:both;"></div>
                                                        </div>
                                                    </div>
