    	...
    	<div class="box">
    		<div class="box-content">
			  <ul id="myTab" class="nav nav-tabs">
                  <li class="active"><a href="<?php echo base_url('labkes/list_user_yang_mengajukan_labkes_utama');?>">Labkes(Sudah Validasi)</a></li> 
				  <li ><a href="<?php echo base_url('labkes/list_user_yang_mengajukan_labkes_utama_belum_validasi');?>">Labkes(Belum Validasi)</a></li> 
				    <li ><a href="<?php echo base_url('labkes/list_user_yang_mengajukan_labkes_utama_perbaikan');?>">Labkes(Perbaikan)</a></li> 
              </ul>
			    <div id="myTabContent" class="tab-content">
			 <div class="tab-pane fade in active">
			 <br>
    			<h3 class="page-header">LIST LABKES YANG MENGAJUKAN KODE(Sudah Validasi)</h3>
<!--
...
<div class="row">
		...
		?>
                <tr>
				  ...
				  <td><?php echo $value['jenis_pratama_utama']; ?></td>
                  ...
                  <td><a href="<?=site_url('labkes/verifikasi_pengajuan_faskes_labkes/'.$this->encrypt->encode($value['id']));?>"><button type="button" class="btn btn-default"><span class="glyphicon glyphicon-zoom-in" aria-hidden="true"></span> Verifikasi</button></a> | <a href="<?=site_url('dashboard/timeline/'.$this->encrypt->encode($value['id']));?>"><button type="button" class="btn btn-default"><span class="glyphicon glyphicon-zoom-in" aria-hidden="true"></span> View Timeline</button></a></td>
                </tr>
            <?php } ?> 
                </tbody>
