    	...
    	<div class="box">
    		<div class="box-content">
			  <ul id="myTab" class="nav nav-tabs">
                  <li class="active"><a href="<?php echo base_url('labkes/list_user_yang_mengajukan_labkes_pratama');?>">Labkes(Sudah Validasi)</a></li> 
				  <li ><a href="<?php echo base_url('labkes/list_user_yang_mengajukan_labkes_pratama_belum_validasi');?>">Labkes(Belum Validasi)</a></li> 
				    <li ><a href="<?php echo base_url('labkes/list_user_yang_mengajukan_labkes_pratama_perbaikan');?>">Labkes(Perbaikan)</a></li> 
              </ul>
