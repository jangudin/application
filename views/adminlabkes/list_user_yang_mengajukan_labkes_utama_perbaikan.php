    		...
    		<div class="box-content">
			  <ul id="myTab" class="nav nav-tabs">
				  ...
				  <li ><a href="<?php echo base_url('labkes/list_user_yang_mengajukan_labkes_utama_belum_validasi');?>">Labkes(Belum Validasi)</a></li> 
				    <li class="active"><a href="<?php echo base_url('labkes/list_user_yang_mengajukan_labkes_utama_perbaikan');?>">Labkes(Perbaikan)</a></li> 
              </ul>
			    <div id="myTabContent" class="tab-content">
			 <div class="tab-pane fade in active">
			 <br>
    			<h3 class="page-header">LIST LABKES YANG MENGAJUKAN KODE(Perbaikan)</h3>
<!--
