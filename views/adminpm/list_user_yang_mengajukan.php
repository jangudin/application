    	...
    	<div class="box">
    		<div class="box-content">
			  <ul id="myTab" class="nav nav-tabs">
                  <li class="active"><a href="<?php echo base_url('pm/list_user_yang_mengajukan');?>">Praktik Mandiri(Sudah Validasi)</a></li> 
				  <li><a href="<?php echo base_url('pm/list_user_yang_mengajukan_belum_validasi');?>">Praktik Mandiri(Belum Validasi)</a></li> 
				    <li ><a href="<?php echo base_url('pm/list_user_yang_mengajukan_belum_validasi_perbaikan');?>">Praktik Mandiri(Perbaikan)</a></li> 
              </ul>
...
<div class="row">
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th>KODE PRAKTIK MANDIRI</th>
                  <th>NAMA PRAKTIK MANDIRI</th>
				  <th>ALAMAT PRAKTIK MANDIRI</th>
				  <th>STATUS</th>
				   <th>STATUS AKTIF</th>
                  <th>ACTION</th>
                </tr>
		...
		?>
                <tr>
				  ...
				  ?>
				   <td><a href="<?=site_url('dashboard/ubah_status_klinik/'.$value['id']);?>"><?php echo $value['status_pm']; ?></a></td>
				   <?php
				  }else{
				   ?>
				   <td><?php echo $value['status_pm']; ?></td>
				   <?php
				  }
				   ?>
                  <td><a href="<?=site_url('pm/verifikasi_pengajuan_faskes/'.$value['id']);?>"><button type="button" class="btn btn-default"><span class="glyphicon glyphicon-zoom-in" aria-hidden="true"></span> Verifikasi</button></a> | <a href="<?=site_url('dashboard/timeline/'.$value['id']);?>"><button type="button" class="btn btn-default"><span class="glyphicon glyphicon-zoom-in" aria-hidden="true"></span> View Timeline</button></a></td>
                </tr>
            <?php } ?> 
                </tbody>
