    	...
    	<div class="box">
    		<div class="box-content">
			  <ul id="myTab" class="nav nav-tabs">
			  		<li ><a href="<?php echo base_url('pm/list_user_yang_mengajukan');?>">Praktik Mandiri(Sudah Validasi)</a></li> 
				  	<li class="active"><a href="<?php echo base_url('pm/list_user_yang_mengajukan_belum_validasi');?>">Praktik Mandiri(Belum Validasi)</a></li> 
