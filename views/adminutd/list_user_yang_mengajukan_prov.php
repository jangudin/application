    	...
    	<div class="box">
    		<div class="box-content">
			  <ul id="myTab" class="nav nav-tabs">
                  <li class="active"><a href="<?php echo base_url('utd/list_user_yang_mengajukan_prov');?>">UTD(Sudah Validasi)</a></li> 
				  <li ><a href="<?php echo base_url('utd/list_user_yang_mengajukan_prov_belum_validasi');?>">UTD(Belum Validasi)</a></li> 
				    <li ><a href="<?php echo base_url('utd/list_user_yang_mengajukan_prov_perbaikan');?>">UTD(Perbaikan)</a></li> 
              </ul>
			    <div id="myTabContent" class="tab-content">
			 <div class="tab-pane fade in active">
			 <br>
    			<h3 class="page-header">LIST UTD YANG MENGAJUKAN KODE(Sudah Validasi)</h3>
<!--
