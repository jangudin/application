        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
             <li  ><a href="<?php echo base_url('rs/verifikasi_pengajuan_faskes_rs/').$user_id;?>">Data Dasar</a></li>
				<li ><a href="<?php echo base_url('rs/verifikasi_pengajuan_faskes_sdm_rs/').$user_id;?>">Data SDM</a></li>
				 <li ><a href="<?php echo base_url('rs/verifikasi_pengajuan_faskes_tt_rs/').$user_id;?>">Data TT</a></li>
				  <li  class="active"><a href="<?php echo base_url('rs/verifikasi_pengajuan_pelayanan_rs/').$user_id;?>">Data Pelayanan</a></li>
			  
			   <li><a href="<?php echo base_url('rs/verifikasikan_kirim_rs/').$user_id;?>">Verifikasikan</a></li>
