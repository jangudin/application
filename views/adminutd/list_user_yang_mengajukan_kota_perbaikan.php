    		...
    		<div class="box-content">
			  <ul id="myTab" class="nav nav-tabs">
				  ...
				  <li ><a href="<?php echo base_url('utd/list_user_yang_mengajukan_kota_belum_validasi');?>">UTD(Belum Validasi)</a></li> 
				    <li class="active"><a href="<?php echo base_url('utd/list_user_yang_mengajukan_kota_perbaikan');?>">UTD(Perbaikan)</a></li> 
              </ul>
			    <div id="myTabContent" class="tab-content">
			 <div class="tab-pane fade in active">
			 <br>
    			<h3 class="page-header">LIST UTD YANG MENGAJUKAN KODE(Perbaikan)</h3>
<!--
