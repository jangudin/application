    	...
    	<div class="box">
    		<div class="box-content">
			  <ul id="myTab" class="nav nav-tabs">
                  <li class="active"><a href="<?php echo base_url('utd/list_user_yang_mengajukan_kota');?>">UTD(Sudah Validasi)</a></li> 
				  <li ><a href="<?php echo base_url('utd/list_user_yang_mengajukan_kota_belum_validasi');?>">UTD(Belum Validasi)</a></li> 
				    <li ><a href="<?php echo base_url('utd/list_user_yang_mengajukan_kota_perbaikan');?>">UTD(Perbaikan)</a></li> 
              </ul>
