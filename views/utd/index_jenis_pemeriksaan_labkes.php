        ...
        <div class="col-md-12" >
          ...
          <div class="box box-primary">
			...
			<table class="table table-bordered">
			 <tbody>
			 <tr>
			 <td>TYPE PELAYANAN</td><td>:</td><td><?=form_dropdown('type',dropdown_jenis_pemeriksaan_type(), '','id="type" class="form-control select2" required');?></td>
			 </tr>
			 <tr>
			 ...
			 <tr>
			  <td>PEMERIKSAAN LAINNYA</td><td>:</td><td><textarea disabled name="pemeriksaan_tambahan_lainnya" id="pemeriksaan_tambahan_lainnya"></textarea></td>
			 </tr>
			 <tr>
			 ...
			 <tr>
			   <td>TENAGA TEKNIS</td><td>:</td><td><?=form_dropdown('fungsional',dropdown_fungsional_labkes(), '','id="fungsional" class="form-control select2" required');?></td>
			 </tr>
			 <tr>
			  <td>TENAGA TEKNIS LAINNYA</td><td>:</td><td colspan="4"><textarea disabled name="fungsional_lainnya" id="fungsional_lainnya"></textarea></td>
			 </tr>
			 <tr>
			    <td>SIP Dokter</td><td>:</td><td><input type="text" name="sip" value=""    class="form-control"  placeholder="SIP" required  autocomplete="off" id="sip" ></td>
			 </tr>
			 <tr>
			 ...
			 <tr>
			  <td>STR Dokter</td><td>:</td><td><input type="text" name="str" value=""    class="form-control"  placeholder="STR"   autocomplete="off" id="str" ></td>
			 </tr>
			 <tr>
			 ...
			 <tr>
			    <td>TANGGAL MULAI </td><td>:</td><td><input type="text" name="tanggal_pendidikan_dan_pelatihan" value=""    class="form-control datepicker"  placeholder="TANGGAL MULAI"   autocomplete="off" id="datepicker" ></td>
			 </tr>
			 <tr>
