...
?>
            <ul class="nav nav-tabs">
			  ...
			  <li class="active"><a href="<?php echo base_url('labkes/inputan_data_sarpras_alkes_labkes');?>" >Data Sarpras & Alkes</a></li>
      ...
      <div class="row">
		...
		<?php
			...
			?>
			 ...
			 <td><?=$no;?></td>
			 <td><?=$value?></td>
			<td><?=form_dropdown('isian['.$key.']',array(''=>'Belum Di Isi','Ada'=>'Ada','Tidak Ada'=>'Tidak Ada'), $isian,'id="isian"  required');?></td>	 
