...
?>
            <ul class="nav nav-tabs">
			  ...
			  <li  ><a href="<?php echo base_url('labkes/inputan_data_sdm_labkes');?>">Struktur Organisasi</a></li>
			   ...
			   <li class="active" ><a href="<?php echo base_url('labkes/selesaikan_labkes');?>">Kirim Data</a></li>
            </ul>
        ...
        <div class="col-md-12" >
          ...
          <div class="box box-primary">
			...
			if(empty($data[0]['final'])){
				$split = explode(" ", $getdatalabkes[0]['jenis_lab']);
			 ?>
			 <tr>
			 ...
			 <input type="hidden" name="jenis_pratama_utama" value="<?=$split[count($split)-1]?>">
			  <input type="hidden" name="id_prov" value="<?=$user[0]['id_prov']?>">
			  <input type="hidden" name="id_kota" value="<?=$user[0]['id_kota']?>">
			   <input type="hidden" name="kode_regional" value="<?=$getdatalabkes[0]['kode_regional']?>">
