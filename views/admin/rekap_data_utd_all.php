		...
		<div class="col-md-12">
			<div class="nav-tabs-custom">
				<ul class="nav nav-tabs">
					...
					<li class="active"><a href="<?php echo base_url('dashboard/rekap_data_utd_all/') . $user_id; ?>">Rekap Data UTD</a></li>
											...
											<table class="table-bordered table-condensed" id="tblExport" style="font-size:12px; margin:10 10 10 0px;" width="100%">
												...
												?>
													<tr>
														...
														<td align="left"><?= $value['nama_utd'] ?></td>
														<td align="left"><?= $value['status_kepemilikan'] ?></td>
														<td align="left"><?= $value['nama_kepala_utd'] ?></td>
														...
														<td align="left">
															...
															list($username, $domain) = explode('@', $value['email_utd']);
