        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
			  <li  ><a href="<?php echo base_url('dashboard/rekap_data/').$user_id;?>">Rekap Data Klinik</a></li>
			    <li ><a href="<?php echo base_url('dashboard/rekap_data_lab/').$user_id;?>">Rekap Data Lab/Bank Jaringan</a></li>
				 ...
				 <li class="active"><a href="<?php echo base_url('dashboard/monitoring_utd_all/').$user_id;?>">Monitoring UTD</a></li>
...
<form method="POST" action="" enctype="multipart/form-data">
	...
	<table class="table-bordered table-condensed" id="tblExport" style="font-size:12px; margin:10 10 10 0px;" width="100%">
		<tr>
			...
			<td  align="left"><b>LAPORAN DETAIL UTD</b></td>
			<td  align="left"><b>KODE FASYANKES KMK 223</b></td>
			<td  align="left"><b>TANGGAL REGISTRASI</b></td>
			<td  align="left"><b>NAMA UTD</b></td>
			<td  align="left"><b>JENIS UTD</b></td>
			<td  align="left"><b>ALAMAT</b></td>
			<td  align="left"><b>KAB/KOTA</b></td>
			<td  align="left"><b>PROVINSI</b></td>
			<td  align="left"><b>TELEPON</b></td>
			<td  align="left"><b>EMAIL</b></td>
			<td  align="left"><b>STATUS DINKES PROVINSI</b></td>
			<td  align="left"><b>STATUS DINKES KAB/KOTA</b></td>
		</tr>
		<?php
		$no=0;
		...
		<tr>
			<td  align="left"><?=$no?></td>
			<td  align="left">
			<a target="_blank" href="<?php echo base_url('dashboard/laporan_detail_data_dasar_utd/').$value['id'];?>">DATA DASAR</a><br>
			<a target="_blank" href="<?php echo base_url('dashboard/laporan_detail_sdm_utd/').$value['id'];?>">SDM</a><br>
			<a target="_blank" href="<?php echo base_url('dashboard/laporan_detail_sarpras_utd/').$value['id'];?>">SARPRAS</a><br>
			<a target="_blank" href="<?php echo base_url('dashboard/laporan_detail_alkes_utd/').$value['id'];?>">ALKES</a><br>
			</td>
			<td  align="left"><?=$value['kode_faskes_baru']?></td>
			<td  align="left"><?=date('d/m/Y',strtotime($value['tgl_buat_user']))?></td>
			<td  align="left"><a target="_blank" href="<?php echo base_url('utd/verifikasi_pengajuan_faskes_utd/').$value['id'];?>"><?=$value['nama_utd']?></a></td>
			<td  align="left"><?=$value['jenis_utd']?></td>
			...
			<td  align="left"><?=$value['email_utd']?></td>
			<td  align="left"><?=(!empty($value['status_validasi_prov']) ? $value['status_validasi_prov'] : (!empty($value['status_validasi_kemkes']) ? $value['status_validasi_kemkes'] : '')) ?></td>
			<td  align="left"><?=$value['status_validasi_kota']?></td>
