    	...
    	<div class="box">
    		<div class="box-content">
			  <ul id="myTab" class="nav nav-tabs">
                  <li class="active"><a href="<?php echo base_url('dashboard/list_user_yang_mengajukan_pma');?>">Klinik(Sudah Validasi)</a></li> 
				  <li ><a href="<?php echo base_url('dashboard/list_user_yang_mengajukan_pma_belum_validasi');?>">Klinik(Belum Validasi)</a></li> 
				    <li ><a href="<?php echo base_url('dashboard/list_user_yang_mengajukan_pma_belum_validasi_perbaikan');?>">Klinik(Perbaikan)</a></li> 
              </ul>
...
<div class="row">
		...
		?>
                <tr>
				  ...
				  ?>
				   <td><a href="<?=site_url('dashboard/ubah_status_klinik/'.$this->encrypt->encode($value['id']).'/list_user_yang_mengajukan_pma');?>"><?php echo $value['status_klinik']; ?></a></td>
				   <?php
				  }else{
				   ?>
