    	...
    	<div class="box">
    		<div class="box-content">
			  <ul id="myTab" class="nav nav-tabs">
                  <li class="active"><a href="<?php echo base_url('dashboard/list_user_dinkes_kota');?>">List User Dinkes Kab/Kota</a></li> 
				   <li><a href="<?php echo base_url('dashboard/list_user_dinkes_kota_belum_validate');?>">List User Dinkes Kab/Kota(Belum Validasi)</a></li> 
              </ul>
			    <div id="myTabContent" class="tab-content">
			 <div class="tab-pane fade in active">
			 <br>
    			<h3 class="page-header">LIST USER DINKES KAB/KOTA</h3>
<?php
if($this->session->userdata('id_kategori')==1){
?>
<!--<a href="<?php echo base_url('dashboard/tambah_user_dinkes_kota');?>"><button class="btn btn-primary" type="button" name="add" value="Tambah" >Tambah</button></a>
-->
<?php
}
?><br><br>
...
?>
<a href="<?=site_url('dashboard/tambah_user_dinkes_kota/'.$this->encrypt->encode($value['id_faskes']));?>"><button type="button" class="btn btn-default"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Edit</button></a><?php
}
?><?php if($this->session->userdata('id_kategori')==2){ ?> | <a onclick="return confirm('Apakah Anda Yakin?');" href="<?=site_url('dashboard/hapus_user_dinkes_kota/'.$this->encrypt->encode($value['id_faskes']).'/list_user_dinkes_kota');?>"><button type="button" class="btn btn-default"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Delete</button></a><?php } ?> </td>
                </tr>
            <?php } ?> 
                </tbody>
