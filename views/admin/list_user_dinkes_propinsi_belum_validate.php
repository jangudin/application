    	...
    	<div class="box">
    		<div class="box-content">
			  <ul id="myTab" class="nav nav-tabs">
                  <li><a href="<?php echo base_url('dashboard/list_user_dinkes_propinsi');?>">List User Dinkes Propinsi</a></li> 
				   <li  class="active"><a href="<?php echo base_url('dashboard/list_user_dinkes_propinsi_belum_validate');?>">List User Dinkes Propinsi(Belum Validasi)</a></li> 
              </ul>
			    <div id="myTabContent" class="tab-content">
			 <div class="tab-pane fade in active">
			 <br>
    			<h3 class="page-header">LIST USER DINKES PROPINSI BELUM DI VALIDASI</h3>
...
<div class="row">
		...
		?>
                <tr>
                  ...
                  <td><a  onclick="return confirm('Yakin DI Validasi?');" href="<?=site_url('dashboard/tambah_user_dinkes_propinsi_belum_validasi/'.$this->encrypt->encode($value['id_faskes']));?>"><button type="button" class="btn btn-default"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span> Validasi</button></a> | <?php if($this->session->userdata('id_kategori')==1){ ?><a onclick="return confirm('Apakah Anda Yakin?');" href="<?=site_url('dashboard/hapus_user_dinkes_propinsi/'.$this->encrypt->encode($value['id_faskes']).'/list_user_dinkes_propinsi_belum_validate');?>"><button type="button" class="btn btn-default"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Delete</button></a><?php } ?> </td>
                </tr>
            <?php } ?> 
                </tbody>
