...
<div class="login-box">
  <div class="login-logo">
    ...
    <a href="<?php echo site_url('admin')?>"><b>PENDAFTARAN FASYANKES</b></a>
  </div>
<?php
 $email='';
...
?>
  ...
  <div class="login-box-body">
    ...
    <form action="<?php echo base_url('admin/cek_login'); ?>" method="post">
     ...
     <a href="<?php echo site_url('register/index')?>" class="btn btn-block btn-info">Daftar User Fasyankes</a>
	 <a href="<?php echo site_url('register/index_dinkes_kota')?>" class="btn btn-block btn-warning">Daftar User Dinkes Kota/Kab/Propinsi</a>
