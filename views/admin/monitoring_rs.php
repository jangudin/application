        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
				   <li  ><a href="<?php echo base_url('dashboard/rekap_data_rs/').$user_id;?>">Rekap Data RS</a></li>
				 <li class="active"><a href="<?php echo base_url('dashboard/monitoring_rs/').$user_id;?>">Monitoring RS</a></li>
            </ul>
...
<form method="POST" action="" enctype="multipart/form-data">
	...
	<table class="table-bordered table-condensed" id="tblExport" style="font-size:12px; margin:10 10 10 0px;" width="100%">
		<tr>
			...
			<td  align="left"><b>NAMA RS</b></td>
			<td  align="left"><b>JENIS RS</b></td>
		...
		<tr>
			...
			<td  align="left"><a target="_blank" href="<?php echo base_url('rs/verifikasi_pengajuan_faskes_rs/').$value['id'];?>"><?=$value['nama_rs']?></a></td>
			<td  align="left"><?=$value['jenis_rs']?></td>
