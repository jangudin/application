		...
		<div class="col-md-12">
			<div class="nav-tabs-custom">
				<ul class="nav nav-tabs">
					...
					<li class="active"><a href="<?php echo base_url('dashboard/monitoring_lab_all/') . $user_id; ?>">Monitoring Lab/Bank Jaringan</a></li>
										...
										<form method="POST" action="" enctype="multipart/form-data">
											...
											<table class="table-bordered table-condensed" id="tblExport" style="font-size:12px; margin:10 10 10 0px;" width="100%">
												<tr>
													...
													<td align="left"><b>NAMA Lab/Bank Jaringan</b></td>
													<td align="left"><b>JENIS Lab/Bank Jaringan</b></td>
													<td align="left"><b>ALAMAT</b></td>
													<td align="left"><b>KAB/KOTA</b></td>
													<td align="left"><b>PROVINSI</b></td>
													<td align="left"><b>TELEPON</b></td>
													<td align="left"><b>EMAIL</b></td>
													<td align="left"><b>STATUS DINKES PROVINSI/KEMKES</b></td>
												...
												?>
													<tr>
														...
														<td align="left"><a target="_blank" href="<?php echo base_url('dashboard/verifikasi_pengajuan_faskes_labkes/') . $value['id']; ?>"><?= $value['nama_lab'] ?></a></td>
														<td align="left"><?= $value['jenis_lab'] ?></td>
														...
														<td align="left">
															...
															list($username, $domain) = explode('@', $value['email_lab']);
