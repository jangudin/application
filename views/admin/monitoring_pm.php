			  ...
			  <!-- <li  ><a href="<?php echo base_url('dashboard/rekap_data/').$user_id;?>">Rekap Data Klinik</a></li>
			    <li ><a href="<?php echo base_url('dashboard/rekap_data_lab/').$user_id;?>">Rekap Data Lab/Bank Jaringan</a></li>
				 ...
				 <li ><a href="<?php echo base_url('dashboard/monitoring_utd_all/').$user_id;?>">Monitoring UTD</a></li> -->
				  <li  ><a href="<?php echo base_url('pm/rekap_data_pm/').$user_id;?>">Rekap Data Praktik Mandiri</a></li>
				 <li class="active"><a href="<?php echo base_url('dashboard/monitoring_pm/').$user_id;?>">Monitoring Praktik Mandiri</a></li>
            </ul>
...
<div class="table-responsive">
	<table class="table-bordered table-condensed" id="tblExport" style="font-size:12px; margin:10 10 10 0px;" width="100%">
		<tr>
			...
			<td  align="left"><b>KATEGORI PM</b></td>
      <td  align="left"><b>KERJA SAMA BPJS</b></td>
      ...
      <td  align="left"><b>Kirim Data Ke SatuSehat</b></td>
      ...
      <td  align="left"><b>URL DOKUMEN KOMITMEN</b></td>
		...
		<tr>
			...
			<td  align="left"><?=$value['kategori_user_pm']?></td>
      ...
      <td  align="left"><a href="<?=$value['url_dokumen_komitmen']?>" target="_blank"><?=$value['url_dokumen_komitmen']?></a></td>
