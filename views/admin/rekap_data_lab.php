		...
		<div class="col-md-12">
			<div class="nav-tabs-custom">
				<ul class="nav nav-tabs">
					...
					<li class="active"><a href="<?php echo base_url('dashboard/rekap_data_lab/') . $user_id; ?>">Rekap Data Lab/Bank Jaringan</a></li>
										...
										<form method="POST" action="" enctype="multipart/form-data">
											...
											<table class="table-bordered table-condensed" id="tblExport" style="font-size:12px; margin:10 10 10 0px;" width="100%">
												<tr>
													...
													<td align="left"><b>BENTUK LAB</b></td>
													<td align="left"><b>PEMILIK LAB</b></td>
												...
												?>
													<tr>
														...
														<td align="left"><?= $value['bentuk_lab'] ?></td>
