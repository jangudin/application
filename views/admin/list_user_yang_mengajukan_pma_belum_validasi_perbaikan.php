    		...
    		<div class="box-content">
			  <ul id="myTab" class="nav nav-tabs">
				  ...
				  <li ><a href="<?php echo base_url('dashboard/list_user_yang_mengajukan_pma_belum_validasi');?>">Klinik(Belum Validasi)</a></li> 
				   <li class="active"><a href="<?php echo base_url('dashboard/list_user_yang_mengajukan_pma_belum_validasi_perbaikan');?>">Klinik(Perbaikan)</a></li> 
              </ul>
			    <div id="myTabContent" class="tab-content">
			 <div class="tab-pane fade in active">
			 <br>
    			<h3 class="page-header">LIST FASYANKES YANG MENGAJUKAN KODE(Perbaikan)</h3>
<!--
