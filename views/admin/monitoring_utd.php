        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
				   <li  ><a href="<?php echo base_url('dashboard/rekap_data_utd/').$user_id;?>">Rekap Data UTD</a></li>
				 <li class="active"><a href="<?php echo base_url('dashboard/monitoring_utd/').$user_id;?>">Monitoring UTD</a></li>
            </ul>
