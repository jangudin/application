    	...
    	<div class="box">
    		<div class="box-content">
			  <ul id="myTab" class="nav nav-tabs">
                  <li class="active"><a href="<?php echo base_url('dashboard/list_timeline');?>">HISTORY</a></li> 
              </ul>
...
<div class="row">
		...
		?>
                <tr>
                  ...
                  <td><a href="<?=site_url('dashboard/timeline/'.$this->encrypt->encode($value['id_faskes']));?>"><button type="button" class="btn btn-default"><span class="glyphicon glyphicon-zoom-in" aria-hidden="true"></span> View Status History</button></a></td>
                </tr>
            <?php } ?> 
                </tbody>
