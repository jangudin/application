        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
			    <li  class="active"><a href="<?php echo base_url('dashboard/rekap_data_labkes/').$user_id;?>">Rekap Data Lab/Bank Jaringan</a></li>
				 <li ><a href="<?php echo base_url('dashboard/monitoring_lab/').$user_id;?>">Monitoring Lab/Bank Jaringan</a></li>
            </ul>
...
<form method="POST" action="" enctype="multipart/form-data">
	...
	<table class="table-bordered table-condensed" id="tblExport" style="font-size:12px; margin:10 10 10 0px;" width="100%">
		<tr>
			...
			<td  align="left"><b>STATUS LABKES</b></td>
		...
		<tr>
			...
			<td  align="left"><?=$value['status_labkes']?></td>
