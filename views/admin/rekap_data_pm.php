    ...
    <div class="col-md-12">
      <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
          ...
          <li class="active"><a href="<?php echo base_url('dashboard/rekap_data_pm/') . $user_id; ?>">Rekap Data Praktik Mandiri</a></li>
          <li><a href="<?php echo base_url('dashboard/monitoring_pm/') . $user_id; ?>">Monitoring Praktik Mandiri</a></li>
        </ul>
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  ?>
                    ...
                    <form class="form-horizontal well" role="form" method="post" action="<?php echo base_url('dashboard/rekap_pm_all_target_blank'); ?>" target="_blank">
                        ...
                        ?>
                          <tr>
                            ...
                            <td align="left">
                              ...
                              list($username, $domain) = explode('@', $value['email_rs']);
