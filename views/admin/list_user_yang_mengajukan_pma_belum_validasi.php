    	...
    	<div class="box">
    		<div class="box-content">
			  <ul id="myTab" class="nav nav-tabs">
                  <li ><a href="<?php echo base_url('dashboard/list_user_yang_mengajukan_pma');?>">Klinik(Sudah Validasi)</a></li> 
				  <li class="active"><a href="<?php echo base_url('dashboard/list_user_yang_mengajukan_pma_belum_validasi');?>">Klinik(Belum Validasi)</a></li> 
			 ...
			 <br>
    			<h3 class="page-header">LIST FASYANKES YANG MENGAJUKAN KODE(Belum Validasi)</h3>
<!--
...
<div class="row">
		...
		?>
                <tr>
                  <td><?php echo $value['kode_faskes_baru']; ?></td>
