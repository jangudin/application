    	...
    	<div class="box">
    		<div class="box-content">
			  <ul id="myTab" class="nav nav-tabs">
                  <li ><a href="<?php echo base_url('dashboard/list_user_yang_mengajukan_labkes');?>">Labkes(Sudah Validasi)</a></li> 
				  <li class="active"><a href="<?php echo base_url('dashboard/list_user_yang_mengajukan_belum_validasi_labkes');?>">Labkes(Belum Validasi)</a></li> 
				    <li ><a href="<?php echo base_url('dashboard/list_user_yang_mengajukan_belum_validasi_perbaikan_labkes');?>">Labkes(Perbaikan)</a></li> 
              </ul>
