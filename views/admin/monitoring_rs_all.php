		...
		<div class="col-md-12">
			<div class="nav-tabs-custom">
				<ul class="nav nav-tabs">
					...
					<li class="active"><a href="<?php echo base_url('dashboard/monitoring_rs_all/') . $user_id; ?>">Monitoring RS</a></li>
										...
										<form method="POST" action="" enctype="multipart/form-data">
											...
											<table class="table-bordered table-condensed" id="tblExport" style="font-size:12px; margin:10 10 10 0px;" width="100%">
												<tr>
													...
													<td align="left"><b>STATUS DINKES KEMKES</b></td>
												...
												?>
													<tr>
														...
														<td align="left"><?= $value['status_validasi_kemkes'] ?></td>
														<td align="left"><?= $value['status_validasi_prov'] ?></td>
