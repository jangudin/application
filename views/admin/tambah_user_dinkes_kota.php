            ...
            <form  method="POST" action="">
              <div class="box-body">
			   ...
			   <div class="form-group">
                  ...
                  <input type="email" readonly name="email" value="<?=$data[0]['email']?>" required class="form-control" autocomplete="off" >
				  </div>
               ...
               <input type="password" name="confirm_password_baru" value="" required class="form-control" autocomplete="off" >
				...
				<div class="col-sm-5">
				<?=form_dropdown('id_kota', dropdown_kota($id_prov), $data[0]['id_kota'],'id="id_kota" class="form-control select2"');?>
				</div>  
				<div style="clear:both;"></div>
				</div>
